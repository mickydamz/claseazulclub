...
const GeneralD = ({ selectedNft }) => {
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Clase Azul</div>
        <div className={style.nftTitle}>{'Clase Azul Club'}</div>
        <div className={style.otherInfo}>
          <div className={style.ownedBy}>
            Owned by <span className={style.accent}>Clase Azul Club</span>
          </div>
