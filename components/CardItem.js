...
<div className="h-screen">
      <div className="w-80 mt-24 m-auto lg:mt-16 max-w-sm">
        <img src="https://ardapps.com/wp-content/uploads/2021/11/head-1.png" alt=""className="rounded-t-2xl shadow-2xl lg:w-full 2xl:w-full 2xl:h-44 object-cover"/>
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
            <div className="col-span-1">
              <img className="w-15 lg:w-12" src="https://img.icons8.com/fluency/48/000000/ethereum.png" alt="music icon"/>
            </div>
            <div className="col-span-2 pt-1">
              <p className="text-gray-800 font-bold lg:text-sm">Price</p>
              <p className="text-gray-500 text-md">2/BNB</p>
            </div>
          ...
          <div class="text-center m-auto mt-1 w-full h-1">
          </div>
